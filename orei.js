...
// NOTA: Idealmente, estas funções estariam em um arquivo 'utils.js' e importadas.
// Mantidas aqui para simplificar a refatoração atual.
// =============================================

function formatDateForDisplay(dateInput) {
    if (!dateInput) return 'Data Inválida';
    // O rehydrate do firestore-service já converteu Timestamps para Date
    if (!(dateInput instanceof Date) || isNaN(dateInput)) return 'Data Inválida';
    
    // Usando toLocaleDateString para respeitar o fuso horário do usuário
    return dateInput.toLocaleDateString('pt-BR', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
        timeZone: 'UTC' // Garante consistência com os dados salvos
    });
}
