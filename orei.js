...
import { getAuth, onAuthStateChanged, GoogleAuthProvider, signInWithPopup, signOut } from 'https://www.gstatic.com/firebasejs/9.22.2/firebase-auth.js'; // Import GoogleAuthProvider and signInWithPopup
...
function updateAuthUI(user) {
    ...
    if (user) {
        authStatus.textContent = "Usuário autenticado: " + user.email + (user.providerData[0].providerId === 'google.com' ? " (via Google)" : "");
