...
relatorioBtn.addEventListener('click', () => { // 'relatorioBtn' agora lida com a exportação (antigo 'Relatório Excel')
    ...
    const downloadAnchor = document.createElement('a'); // Criar link para download
    downloadAnchor.setAttribute("href", URL.createObjectURL(XLSX.write(wb, { bookType: 'xlsx', mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' })));
