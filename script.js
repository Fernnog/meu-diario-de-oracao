...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function recalcularPlanoNovaData(index, novaDataFim) {
        ...
        let dataAtual = novosDiasPlano.length > 0 ? new Date(novosDiasPlano[novosDiasPlano.length - 1].data) : new Date();
    ...
    // Eventos de clique para autenticação
    ...
    // Listener para o botão "Início" na seção de cadastro
