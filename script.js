// script.js (Orquestrador Principal da Aplicação - Versão Consolidada)
// ARQUITETURA FINAL: Utiliza o módulo de autenticação, corrige erros de sintaxe e implementa melhorias de UX.
...
// =================================================================
// === LÓGICA DE AUTENTICAÇÃO E FLUXO DE DADOS (ARQUITETURA CORRETA) ===
// =================================================================

/**
 * Callback que o módulo de autenticação chamará quando o estado do usuário mudar.
...
document.addEventListener('DOMContentLoaded', () => {
    // Inicializa a autenticação usando o módulo centralizado, passando o callback
        ...
        switch(action) {
            ...
            case 'pray-sub-target': {
                try {
                    ...
                    if (target) state.dailyTargets.completed.push({ targetId: subTargetId, isSubTarget: true, title: target.observations[parseInt(obsIndex)].subTargetTitle });
