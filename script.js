    ...
    if (modalElement) {
        ...
        if (modalInstance) {
            modalInstance.hide();
             ...
             // Fallback se a instância não for encontrada (pode acontecer se aberto/fechado rapidamente)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (confirmPerseveranceButton) confirmPerseveranceButton.addEventListener('click', confirmPerseverance);
     ...
     const closePresentationButton = document.getElementById('closePresentationButton');
      ...
      // O Bootstrap já cuida disso, mas podemos adicionar lógica extra se necessário no 'hidden.bs.modal'

    // Expõe funções globais necessárias para onclick="" no HTML (alternativa a adicionar listeners individuais)
    ...
    window.deleteObservation = deleteObservation; // Expor função de deletar observação
