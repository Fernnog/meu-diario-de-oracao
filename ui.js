...
// **MODIFICADO: Função 'renderPriorityTargets' com as tags de categoria e prazo**
export function renderPriorityTargets(allActiveTargets, dailyTargetsData) {
    ...
    priorityTargets.forEach(target => {
        ...
        // --- INÍCIO DA MODIFICAÇÃO: Adição das tags ---
...
// --- INÍCIO DA ADIÇÃO: Nova função para o Toast de Prazos Vencidos ---
export function showExpiredTargetsToast(expiredTargets) {
    ...
    // Opcional: esconder o toast automaticamente após alguns segundos
    setTimeout(() => {
        toast.classList.add('hidden');
    }, 8000); // 8 segundos
}
