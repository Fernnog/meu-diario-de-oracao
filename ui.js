...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.body.addEventListener('click', async e => {
        ...
        switch(action) {
            ...
            // Lógica para exibir/ocultar o formulário inline.
            case 'toggle-sub-observation-form': {
                UI.toggleSubObservationForm(id, isArchived, parseInt(obsIndex));
                break;
            }

            // Lógica para salvar os dados do novo formulário inline.
            case 'save-sub-observation': {
                ...
                applyFiltersAndRender(panelId); // Renderiza para exibir a nova sub-observação
                ...
                try {
                    ...
                    subTarget.subObservations.pop(); // Reverte a UI em caso de erro
                    applyFiltersAndRender(panelId);
                }
                break;
            }
